...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0ms">
                    <img src="images/services/LOGLE.png" class="img-responsive" alt="">
                </div>
                <div class="col-sm-6 padding-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="0ms">
                    <h2>Lab of SICDP</h2>
                    <p>Lab of Social Intelligence and Complex Data Processing( SICDP)  is launched in the July of 2012. After three years research work, we had finished more than 10 funding projects, published 4 books and 16 software certification. There are more than 30 alumnies graduated from our Lab, who research works just focus on the four areas as follow:</p>
                    <ul class="elements">
                        <li class="wow fadeInUp" data-wow-duration="900ms" data-wow-delay="100ms"><i class="fa fa-angle-right"></i>Social Intelligence and Sentiment Analysis</li>
                        <li class="wow fadeInUp" data-wow-duration="800ms" data-wow-delay="200ms"><i class="fa fa-angle-right"></i>Algorithming Trading and Assets Priceing</li>
                        <li class="wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms"><i class="fa fa-angle-right"></i>Knowledge Graph and Service</li>
                        <li class="wow fadeInUp" data-wow-duration="600ms" data-wow-delay="400ms"><i class="fa fa-angle-right"></i>Complexity Data Processing</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section id="recent-projects" class="recent-projects">
        <div class="container">
            <div class="row">
                <h1 class="title text-center wow fadeInDown" data-wow-duration="500ms" data-wow-delay="300ms">The multi-aspect life in the Lab of SICDP:</h1>
